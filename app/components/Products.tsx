          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-7">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <span className="text-lg font-bold block">All New Rush</span>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <span className="text-lg font-bold block">CR - V</span>
                <span className="font-bold block">$120</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-2 text-center">
                <span className="text-lg font-bold block">All New Terios</span>
                <span className="font-bold block">$120</span>
              </div>
            </div>
